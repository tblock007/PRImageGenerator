...
(SSBU) from the .csv export of aisight's GlickoMan player rankings management 
program (http://smashboards.com/threads/glickoman-player-ratings-manager.328804/).
